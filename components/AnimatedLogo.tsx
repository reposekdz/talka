...
const AnimatedLogo: React.FC<AnimatedLogoProps> = ({ className }) => {
    // FIX: Explicitly type svgVariants with Variants to ensure type safety.
    ...
    // FIX: Explicitly type pathVariants with Variants to fix type incompatibility with 'ease' property.
    ...
    return (
        <motion.svg
            ...
            animate="visible"
        >
            {/* FIX: Removed the object wrapper for props and passed variants directly to allow for proper type checking. */}
            <motion.path
